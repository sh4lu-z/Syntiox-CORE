...
**IMPORTANT:** The MCP server path is `D:\\01_PROJECTS\\00_ACTIVE\\J.A.R.V.I.S\\MCP\\google\\docs_handlers.py`.
...
result = run_mcp_tool(
    r"D:\\01_PROJECTS\\00_ACTIVE\\J.A.R.V.I.S\\MCP\\google\\docs_handlers.py",
    "TOOL_NAME_HERE",
    {"arg1": "value"}
)
print(result)
